...
import { PROFILES_INTRO_TEXT } from "./copy";
...
export default function ProfilesSummaryRow({ profiles, unlocked = false, layout = "row" }: ProfilesSummaryRowProps) {
  ...
  if (layout === "card") {
    return (
      <div className="relative flex h-full flex-col items-center justify-center gap-[8px] rounded-[12px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.02)] p-[14px] text-center">
        ...
        <span className={`font-['Segoe_UI_Variable',sans-serif] text-[12px] leading-[16px] ${introTextClass}`}>{PROFILES_INTRO_TEXT}</span>
    ...
    return (
      <div className="relative flex w-full flex-col gap-[8px] rounded-[8px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.02)] px-[12px] py-[10px]">
        <div className="flex items-center gap-[8px]">
          ...
          <span className={`min-w-0 flex-1 font-['Segoe_UI_Variable',sans-serif] text-[12px] leading-[16px] ${introTextClass}`}>{PROFILES_INTRO_TEXT}</span>
        </div>
